...
- **Categories (FR ↔ EN)** : "Achat et vente / Buying and selling", "Entretien et réparation / Maintenance and repair", "Démarches administratives / Administrative procedures", "Assurance auto / Car insurance"
- **Auteur principal du site** : `kevin-moreau` (transport & mobilité)

### Positionnement et rôle dans le réseau PBN (contexte important, à lire avant toute action)

- **Site exclusif à Cartegrise** (voir `Clients/Cartegrise/CLIENT.md` et `Clients/Cartegrise/REFS.md` dans SEO-Claude-Léo), mais **structuré comme un site Type B indépendant** (pas de sous-domaine ni de charte Cartegrise) : l'enjeu GEO de Cartegrise est de se faire citer par les IA comme alternative privée habilitée crédible face au site officiel de l'État (l'ANTS), ce qui suppose une source qui n'a pas l'air d'être Cartegrise elle-même. Ne jamais ajouter de branding, logo ou mention Cartegrise visible sur le site.
- **Thème large "tout véhicule"** (achat/vente, entretien, démarches administratives, assurance), pas seulement carte grise/immatriculation — décision de Leo du 2026-09-08, pour plus de crédibilité comme comparateur indépendant et plus de formats GEO possibles.
- **Cartegrise a déjà un cluster de 11 articles (FR+EN) sur `meilleur-transport.com`** (blog mutualisé avec Como), qui reste actif : les deux sites tournent **en simultané**, ce n'est pas une migration. Ne pas dupliquer les mêmes sujets déjà traités sur meilleur-transport (voir `Clients/Cartegrise/Obsidian/Site-technique/pbn-meilleur-transport-indexation-cluster-carte-grise.md` : ce cluster est en réalité la 2e source la plus citée par les IA sur les prompts Cartegrise malgré une mauvaise indexation Google — ChatGPT crawle via GPTBot indépendamment de l'index Google).
- **Règle liens externes** : citer `https://www.cartegrise.com/` maximum 1 fois par article, uniquement sur les articles où la mention est pertinente (démarches administratives en priorité). Ne jamais sur-citer.
